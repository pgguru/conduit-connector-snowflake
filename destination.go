...
func (d *Destination) handleInsert(ctx context.Context, r sdk.Record, b *destination.Batch) error {
...
func (d *Destination) handleUpdate(ctx context.Context, r sdk.Record, b *destination.Batch) error {
	if !d.hasKey(r) {
...
func (d *Destination) handleDelete(ctx context.Context, r sdk.Record, b *destination.Batch) error {
	if !d.hasKey(r) {
...
func (d *Destination) upsert(ctx context.Context, r sdk.Record, b *destination.Batch) error {
...
func (d *Destination) remove(ctx context.Context, r sdk.Record, b *destination.Batch) error {
	key, err := d.getKey(r)
	if err != nil {
		return err
	}
...
func (d *Destination) insert(ctx context.Context, r sdk.Record, b *destination.Batch) error {
	tableName, err := d.getTableName(r)
	if err != nil {
		return err
	}
...
// columns and values for upserting into Snowflake.
