...
func TestDestination_Snapshot(t *testing.T) {
...
func TestDestination_CDC(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
...
func TestDestination_Snapshot_Empty_Table(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
...
func TestDestination_CDC_Empty_Stream(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
...
func TestDestination_Snapshot_Off(t *testing.T) {
	ctx := context.Background()
...
func TestDestination_keysFromConfig(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
...
func TestDestination_keyColumnsFromTableMetadata(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
...
func TestDestination_keyColumnsFromOrderingColumn(t *testing.T) {
	cfg, err := prepareConfig()
	if err != nil {
		t.Skip()
	}
